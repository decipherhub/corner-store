...
| RFQ reference service | B+ | EIP-712 SDK, module conformance, local demo HTTP API/CLI와 durable coordinator/reference file store smoke가 존재함 | HA transactional coordinator store, signer custody, production pricing/risk freshness와 service hardening 필요 |
